...
public class AccesoBD {
	 ...
	 * @param sqlSentence
	 * @return null si la conexion esta cerrado sino crea una tabla temporal
	 * @throws SQLException
	 */
	 ...
	 * @param slqSentence
	 * @return -1 si la conexion es nula sino devuelve el numero de filas afectadas
	 * @throws SQLException
	 */
	synchronized public int executeUpdater(String slqSentence) throws SQLException{
		if(conexion==null) return -1;
		Statement sentence =(Statement) conexion.createStatement();
		return ((java.sql.Statement) sentence).executeUpdate(slqSentence);
	}
}
