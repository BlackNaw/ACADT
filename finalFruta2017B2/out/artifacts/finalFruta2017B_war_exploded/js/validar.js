...
(function (g) {
    ...
    FRUTA.Validar = {
        ...
        cadenaSinespacio: function (parametros) {
            ...
            var expregular = new RegExp("^([A-Za-zñÑ]{" + parametros.valorMinimo + "," + parametros.valorMaximo + "})$");
...
FRUTA.Validar.cadenaConespacio = function (parametros) {
    var re = new RegExp("^([A-Za-zñÑ\\s\\W]{" + parametros.valorMinimo + "," + parametros.valorMaximo + "})$");
